  ...
  begin
    ...
    begin
      ...
      begin
       ...
       begin
        ShowMessage('Campo obrigatório' + (Form.Components[i] as TEdit).Hint);
      ...
      begin
       ...
       begin
        ShowMessage('O campo' + (Form.Components[i] as TMaskEdit).Hint + 'é obrigatório');
      ...
      begin
       ...
       begin
        ShowMessage('O campo' + (Form.Components[i] as TComboBox).Hint + 'é obrigatório');
