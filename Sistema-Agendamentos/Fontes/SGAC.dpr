...
uses
  ...
  unit_usuarios_grupos_consulta in 'unit_usuarios_grupos_consulta.pas' {form_usuarios_grupos_consulta},
  unit_usuarios_permissoes in 'unit_usuarios_permissoes.pas' {form_usuarios_permissoes};
