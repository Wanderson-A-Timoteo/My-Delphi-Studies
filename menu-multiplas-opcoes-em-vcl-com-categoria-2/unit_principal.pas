...
begin
  ...
  // Ao entrar com mouse no botão altera a cor de font para black
...
begin
  // Ao sair com mouse do botão altera a cor de font para original
  (TComponent(Sender) as TSpeedButton).Font.Color :=  clWhite;
