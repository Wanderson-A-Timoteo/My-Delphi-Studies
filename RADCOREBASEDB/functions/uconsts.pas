...
const
  ...
  SOFTWAREHOUSE_COMMERCIAL_PHONE      = '85998621405' ;
  SOFTWAREHOUSE_FINANCIAL_PHONE       = '85998621405' ;
  SOFTWAREHOUSE_SUPPORT_PHONE         = '85998621405' ;

  SOFTWAREHOUSE_COMMERCIAL_EMAIL      = 'mikromundo@gmail.com';
  SOFTWAREHOUSE_COMMERCIAL_EMAIL_PASS = '';
  SOFTWAREHOUSE_FINANCIAL_EMAIL       = 'mikromundo@gmail.com';
  SOFTWAREHOUSE_FINANCIAL_EMAIL_PASS  = '';
  SOFTWAREHOUSE_SUPPORT_EMAIL         = 'mikromundo@gmail.com';
  SOFTWAREHOUSE_SUPPORT_EMAIL_PASS    = '';

  SOFTWAREHOUSE_SITE                  = 'https://www.radcore.pro.br';
  ...
  USER_ADMIN_PASS                     = 'E3AFED0047B08059D0FADA10F400C1E5';
  ...
  // v. 3.3.0.2
  //ARRAY_BASICS : array [1..1] of string = ( '' ); // se não for usar "frmCadBASICS", descomente essa linha e comente a linha abaixo
                                                    // if you are not using "frmCadBASICS", uncomment this line and comment the line below
