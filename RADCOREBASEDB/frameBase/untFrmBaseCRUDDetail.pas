unit untFrmBaseCRUDDetail; // v. 4.1.0.0
...
begin
  ...
  rc_UpdateDBComboBox( self, true ); // v. 4.0.0.5
...
//                               '''''y=' + dbgSearchCRUD.JSName + '.getEl().getTop() '''','+
    ...
    // no detail, pelo menos por enquanto, não haverá opção de pesquisa
    // in the detail, at least for now, there will be no search option
    edQuickSearch.Visible  := false;//edQuickSearch.Enabled;//( btnNewReg.Enabled );//( not bModelCrud2 ) ;
    btnQuickSearch.Visible := false;//edQuickSearch.Visible ;
    ...
    begin
       ...
       //rc_RenderLayout( Self, true, true, true, true ); // v. 4.0.0.0
    end;
    // v. 3.3.0.0
...
//          'width:105 mobile-v-46 mobile-h-115|'+
          ']]';
...
//      paBaseBackGround.Color := clWhite;
      ...
      paGC.Height          := 78;
        ...
        btnSaveReg.Caption   := '';
        btnSaveReg.Width     := 33;
        btnSaveReg.Height    := btnSearch.Height;
        ...
        btnCancelReg.Height    := btnSearch.Height;
