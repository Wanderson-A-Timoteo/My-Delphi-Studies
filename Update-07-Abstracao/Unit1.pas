unit Unit1;
{
 ...
 ABSTRAÇÂO é a capacidade da linguagem de representar um objeto
 do mundo real para dentro da linguagem de programação. Essa é uma das
...
begin
  CadastrarCliente('Wanderson', '6533322255', 'Rua dos desesperados 100', 'Cuiabá');
end;
