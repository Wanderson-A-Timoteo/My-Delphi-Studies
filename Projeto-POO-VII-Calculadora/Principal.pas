...
begin
  Calculadora.Add(Edit1.Text).Add(Edit2.Text).Dividir.Executar;
end;

procedure TForm1.btnMultiplicarClick(Sender: TObject);
begin
  Calculadora.Add(Edit1.Text).Add(Edit2.Text).Multiplicar.Executar;
end;

procedure TForm1.btnSomarClick(Sender: TObject);
begin
  Calculadora.Add(Edit1.Text).Add(Edit2.Text).Somar.Executar;
end;

procedure TForm1.btnSubtrairClick(Sender: TObject);
begin
  Calculadora.Add(Edit1.Text).Add(Edit2.Text).Subtrair.Executar;
end;
