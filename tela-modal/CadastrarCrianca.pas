  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if FieldByName('sair_sozinho').AsString = 'SIM' then
        begin
...
begin
  ...
  begin
    TMessageDialog.Warning('Número da pulseira é obrigatório!');
  ...
  begin
    ...
    if not IsEmpty then
    begin
      TMessageDialog.Warning('Número de pulseira já cadastrada!');
      EditNumeroPulseira.SetFocus;
      Exit;
    end;
  end;
...
begin
  ...
  begin
    ...
    case RadioGroupSairSozinho.ItemIndex of
      0:FieldByName('sair_sozinho').AsString         := 'SIM';
      1:FieldByName('sair_sozinho').AsString         := 'NÃO';
    end;
