...
-- -----------------------------------------------------
-- Table `agendamentos`.`lojas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS public.lojas
(
    id_loja integer NOT NULL,
    ds_razao_social character varying(150) COLLATE pg_catalog."default",
    ds_fantasia character(150) COLLATE pg_catalog."default",
    ds_endereco character(30) COLLATE pg_catalog."default",
    nr_numero character varying(6) COLLATE pg_catalog."default",
    ds_bairro character(30) COLLATE pg_catalog."default",
    ds_complemento character varying(255) COLLATE pg_catalog."default",
    ds_cidade character varying(255) COLLATE pg_catalog."default",
    ds_uf character(2) COLLATE pg_catalog."default",
    nr_ibge_cidade integer NOT NULL,
    nr_cep character(10) COLLATE pg_catalog."default",
    nr_cnpj character(18) COLLATE pg_catalog."default",
    nr_inscricao_estadual character(18) COLLATE pg_catalog."default",
    ds_email character varying(40) COLLATE pg_catalog."default",
    nr_telefone1 character varying(16) COLLATE pg_catalog."default",
    nr_telefone2 character varying(16) COLLATE pg_catalog."default",
    ds_obs character varying(255) COLLATE pg_catalog."default",
