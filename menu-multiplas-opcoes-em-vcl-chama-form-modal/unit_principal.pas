...
type
  Tform_principal = class(TForm)
    ...
    procedure btn_usuarios_grupo_usuariosClick(Sender: TObject);
  private
...
procedure Tform_principal.btn_usuarios_grupo_usuariosClick(Sender: TObject);
begin
  form_modelo2 := Tform_modelo2.Create(Self);
  prc_controlar_menu(nil, False);
  form_modelo2.ShowModal;
end;
