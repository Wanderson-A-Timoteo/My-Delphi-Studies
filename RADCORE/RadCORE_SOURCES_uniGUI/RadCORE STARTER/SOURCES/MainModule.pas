...
uses
  ...
  RTTI,
  SysUtils, Classes, System.Types, System.StrUtils, // v. 3.0.0.0
  uconsts, System.IniFiles, uniGUIFrame, Vcl.Graphics, // untClsEnderecoCompleto, // v. 3.0.0.0
  uniGUIForm, uniPageControl,                       // v. 3.0.0.0
  Vcl.AppEvnts, uniTimer;

type
    tpPermissions = ( tpAccess, tpRegister, tpEdit, tpDelete ); // v. 3.0.0.0
...
type
  ...
  rgSide_Menu = record
                  ...
                  Hidden  : Boolean;
                  AskNew  : Boolean; // v. 3.0.0.0
                  GenID  : Boolean; // v. 3.0.0.0
                  Modal  : Boolean; // v. 3.0.0.0
...
uses
  ...
  untdm_rc,
  Main;//untDM_LOOKUPs,  untDM_TOTALS; // v. 3.0.0.0
...
begin
     ...
     CONFIG_APP_TYPE           := 'default';  // RENAME "padrao" folder to "default" on files/images folder
     CONFIG_APP_SUBTYPE        := '';
