...
begin
     ...
     rc_BuildMenuItem( mm.varA_MenuOptions, iSeqMenu, 0, mm.MNU_OTHERS_TRAINNING   , '', '', 'link:https://youtu.be/-Gzz7wKE-r4/', '' ); // v. 3.0.0.0
     rc_BuildMenuItem( mm.varA_MenuOptions, iSeqMenu, 2, mm.MNU_OTHERS_SUPPORT     , '', '', '', '' );
     rc_BuildMenuItem( mm.varA_MenuOptions, iSeqMenu, 0, mm.MNU_OTHERS_OPEN_TICKET , '', '', 'link:https://app.radticket.com.br', '' ); // v. 3.0.0.0
