             ...
             begin
                ...
                begin
                    TUniControl( TComponent( pForm ).Components[I] ).ClientEvents.ExtEvents.Values['afterrender'] :=
                       ...
                       '{ sender.bodyEl.dom.addEventListener( ''keydown'', function(e) { ' +
                     ...
                     *)
                     ...
                     begin
                        ...
                        begin
                           ...
                           if ( Pos( 'mobile-v', cTemp3 ) > 0 ) and ( mm.varB_Mobile_Screen_Portrait ) then
                              cCaption := ''
                           else
                           if ( Pos( 'mobile-h', cTemp3 ) > 0 ) and ( mm.varB_Mobile_Screen_Landscape ) then
                              cCaption := ''
                           else
                           if ( ( Pos( 'mobile', cTemp3 ) > 0 ) and (  Pos( 'mobile-', cTemp3 ) = 0 ) ) and ( mm.varB_Mobile_Screen ) then
                             cCaption := ''
                           else
                           if ( Pos( 'desktop', cTemp3 ) > 0 ) and ( not mm.varB_Mobile_Screen ) then
                             cCaption := '';
...
//                                     ' </div>' ;
                              ...
                              begin
                                  ...
                                  begin
                                     if 1=2 then //pQryMaster <> nil then
...
//                                        end;
                        ...
                        begin
                            ...
                            begin
                               ...
                               // v. 4.1.0.0
                               // bsvideo
                               // [PT] não use alClient no htmlframe, use Anchors
                               // [EN] don't use alClient in htmlframe, use Anchors
                               if Pos( 'bsvideo:' , cHint ) > 0 then
                               begin
                                  if Pos( 'youtube.com', cHint ) = 0 then
                                  begin
                                     if ( Pos ( ' w:', cHint ) = 0 ) then
                                        cTemp := '<div class="video-file-responsive"><video width="100%" heigth="100%"'
                                     else
                                     begin
                                        cTemp2 := rc_GetHintProperty( 'w:', cHint, True );
                                        cTemp3 := rc_GetHintProperty( 'h:', cHint, True );
                                        cTemp  := '<div><video width="' + cTemp2 + '" heigth="' + cTemp3 + '"' ;
                                        cHint  := StringReplace( cHint , 'w:' + cTemp2 , '' , [rfReplaceAll] );
                                        cHint  := StringReplace( cHint , 'h:' + cTemp3 , '' , [rfReplaceAll] );
                                        cTemp2 := '';
                                        cTemp3 := '';
                                     end;
...
begin
   ...
   begin
      ...
      if ( cTemp3 = 'mobile-xy' ) then
      begin
         if ( mm.varB_Mobile_Screen ) then
            rc_CenterObj( oObjTemp, oObjTemp2 , true, true , y, x );
      end
      else
      if ( cTemp3 = 'mobile-x' ) then
      begin
         if ( mm.varB_Mobile_Screen ) then
            rc_CenterObj( oObjTemp, oObjTemp2 , false, true , y, x );
      end
      else
      if ( cTemp3 = 'mobile-y' ) then
      begin
         if ( mm.varB_Mobile_Screen ) then
            rc_CenterObj( oObjTemp, oObjTemp2 , true, false , y, x );
      end
...
//                             end;
                        ...
                        begin
                            ...
                            begin
                               ...
                               if ( Pos( 'mobile-', cTemp3 ) > 0 ) and ( mm.varB_Mobile_Screen ) then
                               begin
