...
type
  TfrmCadRECIBOS = class(TfrmBaseCRUD)
    ...
    (*<prj-nofortes-1>*)procedure EmitirReciboSimples1Click(Sender: TObject);
  private
...
uses untdm_rc, MainModule, untFrmLookUp, Main, // untDM_LOOKUPs,  // v. 3.0.0.0
     (*<prj-nofortes-0*)untReportReciboSimples, mkm_func_report,(*prj-nofortes-0>*) mkm_func_web;
...
begin
  ...
  begin
     pFormAtual := frmReportReciboSimples; // v. 3.0.0.0
     ...
     End;
       ...
       dm_rc.rc_ShowMessage( mm.MSG_SELECT_VALID_RECORD ); // v. 3.0.0.0
end;
(*<prj-nofortes-3>*)
