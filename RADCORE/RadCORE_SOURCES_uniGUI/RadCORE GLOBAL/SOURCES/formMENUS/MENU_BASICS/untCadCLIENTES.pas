...
uses
  ...
  uniMainMenu, uniHTMLFrame, Data.FMTBcd, Data.SqlExpr, uniSpinEdit, uniMemo, Vcl.Menus, uniSweetAlert;
...
begin
  inherited;
  dm_rc.rc_LookUpSearchFilter( Sender, '', '', '', '[[fieldmasks:descricao[[title:translate(descricao)]];' );
end;
...
begin
  ...
  // é pra exibir TODAS as EMPRESAS ? descomente o filtro
  //
...
procedure TfrmCadCLIENTES.UniSpeedButton1Click(Sender: TObject);
begin
  inherited;
