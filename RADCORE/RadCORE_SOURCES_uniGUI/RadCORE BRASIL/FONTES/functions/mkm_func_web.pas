...
// v. 3.3.3.2
function rc_NumberExtension (valor: real; pLang : TRCLanguagesType = ltpt_BR; pCurr_Name : string =  'R$'; pCurr_NamePlural : string = 'Real'; pCurr_Symbol : string = 'Reais' ): string;
// v. 4.0.0.0
