...
uses
  ...
  mkm_gridblock, mkm_layout, mkm_anim, mkm_translate, mkm_login, untFrmBaseCRUD; // v. 4.1.0.0
...
begin
     ...
     begin
          ...
          //[EN]
          // for older uniGUI versions, comment out the line below
          // in case your search is duplicating items
...
begin
  ...
  rc_BringToFront( paCompanies ); // v. 4.1.0.0
  rc_BringToFront( paTourTransp ); // v. 4.1.0.0
...
begin
     ...
     //dm_rc.rc_ShowTour( Self ); // v. 4.1.0.2
     mm.varI_GuideTourSeq := 0;
end;
// v. 4.1.0.0
procedure TMainForm.btnNotificationsClick(Sender: TObject);
begin
     dm_rc.rc_ShowHideObject( btnNotifications,
                              paNotifications,
                              btnNotifications.Left - paNotifications.width + 40,
                              ( btnNotifications.Height + 20 ),
                              1,
                              false,
