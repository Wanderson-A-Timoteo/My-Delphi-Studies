...
begin
  ...
  sqlMaster.SQL.Text := ' SELECT [[fields]] ' +
                        ...
                        //'   tab.[[pk]] as "CÓDIGO", tab.nome as "FUNCIONÁRIO", tab.ativo as "STATUS", ' +
...
//                        ']]';
  ...
  (*
   [PT] para criar uma lista fixa em uma query para uso em combobox/lookupcombobox
   [EN] to create a fixed list in a query for use in combobox/lookupcombobox

   select '01' as ID, 'ITEM 1' as DESCRIPTION from ufs
   union
   select '02' as ID, 'ITEM 2' as DESCRIPTION from ufs
   union
   select '03' as ID, 'ITEM 3' as DESCRIPTION from ufs
  *)
