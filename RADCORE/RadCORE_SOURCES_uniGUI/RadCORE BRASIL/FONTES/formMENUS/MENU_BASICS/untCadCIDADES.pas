...
begin
  ...
  dbgSearchCRUD.Hint := '[[' +
                        'fieldmasks:'+
                        //'grid-forcefit:5 mobile-v-5 mobile-h-5|' + // v. 4.0.0.0
                        //'grid-noforcefit|' +
                        'grid-resize|'+
                        ...
                        //'codigo[[align:c|width:300 mobile:90]];' + // v. 4.0.0.0
                        'codigo[[align:c]];' +
                        //'codigo[[align:c|width:10% mobile-v:45% mobile-h:45%]];' +
                        //'descricao[[width:50% mobile-v:55% mobile-h:55%]];' +
                        //'uf[[visible:false mobile]];' +
                        //'uf[[visible:false mobile|width:40%]];' +
                        ']]';
