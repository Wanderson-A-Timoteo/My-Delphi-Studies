inherited frmBARCODE: TfrmBARCODE
  Hint = '[['#13#10'width:max |'#13#10'height:max |'#13#10'modal:'#13#10']]'#13#10
  Caption = 'frmBARCODE'
  DesignSize = (
    360
    360)
  ...
  object paBackground: TUniContainerPanel [0]
    ...
    object paCamera: TUniContainerPanel
      ...
      TabOrder = 1
      object htmlBarCode: TUniHTMLFrame
        Left = 0
        Top = 0
        Width = 320
        Height = 240
        ...
        AutoScroll = True
        Align = alClient
        OnAjaxEvent = htmlBarCodeAjaxEvent
        ScrollHeight = 240
        ScrollWidth = 320
      end
    end
    object btnInit: TUniButton
      Left = 18
      Top = 273
      Width = 60
      Height = 31
      ...
      ClientEvents.ExtEvents.Strings = (
        'click=function click(sender, e, eOpts)'#13#10'{'#13#10'  getScan();'#13#10'}')
