...
begin
     ...
     rc_BuildMenuItem( mm.varA_MenuReport, iSeqMenu, 0, 'Rel. Clientes'                 , '', '', 'reportMenuClientes', '' );
        ...
        rc_BuildMenuItemPermission( mm.varA_MenuReportPermissions, iSeqMenu, iSeqMenuPermission, '<A>' );
        rc_BuildMenuItemPermission( mm.varA_MenuReportPermissions, iSeqMenu, iSeqMenuPermission, 'Clientes - Simples' );
        rc_BuildMenuItemPermission( mm.varA_MenuReportPermissions, iSeqMenu, iSeqMenuPermission, 'Clientes - Completa' );
