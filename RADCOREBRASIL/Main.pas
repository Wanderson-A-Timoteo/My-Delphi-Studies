...
uses
  ...
  mkm_gridblock, mkm_layout, mkm_anim, mkm_translate, mkm_login;
...
//     rc_UpdateCharts; // v. 4.0.0.0 - in tests
end;
// v. 3.3.2.0
...
begin
     ...
     //rc_UpdateCharts; // v. 4.0.0.0 - in tests
     rc_AddFormFrameInTab( nil, 'DashBoard', '', 'DashboardECOMMERCE' , false, false, aftNone, 0, tabDashBoard, false, false );
     //rc_AddFormFrameInTab( nil, 'DashBoard', '', 'FISHFACT' , false, false, aftNone, 0, tabDashBoard, false, false );
end;
// v. 4.0.0.6
...
begin
  ...
  //labAdm.Visible := dm_rc.memUsers.FieldByName('master').AsString = mm.VALUE_YES; // v. 4.0.0.0
...
begin
       ...
       if paNotifications.Tag = 0 then
       begin
            paNotifications.Left := btnNotifications.Left - paNotifications.width + 40 ;
            paNotifications.top  := ( btnNotifications.Height + 20 ) * (-1);//btnNotifications.Top + btnNotifications.Height ;

            paNotifications.Visible := True;
            paNotifications.Tag     := 1;
                 ...
                 begin
                    ...
                    begin
                       ...
                       begin
                          ...
                          //oSBox.Tag    := -99999;
                          dm_rc.rc_ShowToaster( 'warning', 'Click anyplace to close keyboard !', false, 'pinItUp' );
                       end;
                    end;
                 end;
             end;
...
End;
// v. 4.0.0.5
procedure TMainForm.rc_MainMenuClick;
var
   iMenuW : integer;
   oObj : TUniControl;
   oFrameFormInParent : TObject; // v. 3.4.0.0
...
//        iMenuW := paLayoutMainMenu.Width - 36;
     ...
     begin
           ...
           begin
              ...
              begin
                 paLayoutMainMenu.Left := paLayoutMainMenu.Left + paLayoutMainMenu.Width;
                 btnMenu.Left          := btnMenu.Left + paLayoutMainMenu.Width;
              end;
           end
           else
...
begin
    UniSession.AddJS( paNotifications.JSName +
                    '.animate({ duration: ' + inttostr( 400 ) +
                    ', to: { y:' + inttostr( btnNotifications.Top + 20 ) +            // vertical
                    ', opacity: ' + inttostr( 0  ) + ' } } );');
    //paNotifications.Visible := False; // v. 4.0.0.4
end;
// v. 4.0.0.0
//procedure TMainForm.rc_UpdateCharts;
//begin
//     if rc_FindControl( 'sboxGridBlock' ) <> nil then
//        if sboxGridBlock.Visible then
//        begin
//           sboxGridBlock.Visible := false;
//           rc_AddFormFrameInTab( nil, 'DashBoard', '', 'DashboardECOMMERCE' , false, false, aftNone, 0, tabDashBoard, false, false );
//        end;
//end;
