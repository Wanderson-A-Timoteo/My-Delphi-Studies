...
var
   cTable, cField, cWhere, cAnd, cContent,
...
//          else
    ...
    begin
       if cState = 'I' then
          cSql := ' select ' + cField +
                  ' from  ' + cTable +
                  ' where ' + cField + ' = ' + varIIF( Pos( 'not-exists<str>', cHint ) > 0 , QuotedStr( cContent ), cContent )
       else
       if cState = 'E' then
          cSql := ' select ' + cField +
                  ' from  ' + cTable +
                  ' where ' + cField + ' = ' + varIIF( Pos( 'not-exists<str>', cHint ) > 0 , QuotedStr( cContent ), cContent ) +
                  ' and   ' + cPk    + ' <> ' + oQuery.FieldByName( cPK ).AsString;
           ...
           begin
              ...
              begin
                 ...
                 begin
                    ...
                    begin
                       ...
                       begin
                            ...
                            begin
                                 ...
                                 begin
                                    cTmp2 := cTmp2 + ' ';
                                    cTmp2 := Copy( cTmp2, 1, pos( ' ', cTmp2 ) - 1 );
                    ...
                    begin
                        Result := False;
                        dm_rc.rc_ShowSweetAlert( mm.MSG_ERROR, cMsg, 'warning', pFormFrame, oObj.Name ); // v. 4.0.0.5
                    end;
                 end;
              end;
