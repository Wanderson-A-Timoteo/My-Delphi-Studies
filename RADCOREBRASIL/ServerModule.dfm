object sm: Tsm
  ...
  ServerMessages.TerminateTemplate.Strings = (
    ...
    '        <div class="main">'
    '            <h1></h1>'
    '            <div class="error-code">[[MSGSESSIONOVER]]</div>'
    '            <h2></h2>'
    ...
    '            <div class="help-actions">'
      ...
      '                <a href="javascript:location.reload();">Restart ' +
      'System</a>'
    
      '                <a href="javascript:history.back();">Go to Previ' +
      'ous Page</a>'
    '                <a href="[[WEBSITE]]">Go to Company WebSite</a>'
    '            </div>'
    '        </div>'
    '    </div>'
    '</body>'
