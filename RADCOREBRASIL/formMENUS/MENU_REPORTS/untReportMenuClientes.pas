...
uses
  ...
  uniDBEdit, uniSpeedButton, uniDBDateTimePicker, uniSweetAlert;
...
begin
  ...
  //
  dm_rc.rc_FillSearchFieldsCRUD( Self, lbxReportOptions.name, 'Rel. Clientes - Simples'         , 'frmReportClientesSimples' );
  dm_rc.rc_FillSearchFieldsCRUD( Self, lbxReportOptions.name, 'Rel. Clientes - Completa'        , 'frmReportClientesCompleto' );
  dm_rc.rc_FillSearchFieldsCRUD( Self, lbxReportOptions.name, 'Rel. Clientes - Aniversariantes' , 'frmReportClientesAniversariantes' );
