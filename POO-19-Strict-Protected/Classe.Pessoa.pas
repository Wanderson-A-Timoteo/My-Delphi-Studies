...
type
  ...
  strict protected // Somente as classes Pai e Filhos tem Acesso
    FSoFamilia : String;
  ...
  protected // Grupo Whatsapp da Familia
    FWhatsapp : String;

  published //Blo post Administrador
    FPost : String;

  public //Postagem no Facebook
