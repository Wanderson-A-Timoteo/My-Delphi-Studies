...
var
  ...
  ok: Boolean;
begin
  // Essa operação cria um arquivo vazio com o nome associado ao AssignFile.
  // O conteúdo do arquivo será apagado se esse arquivo já existir.
  ...
  Write(files, x, y);  //Escreve 10 e depois 7 sem espaço
 ...
 // terceira linha
  ...
  Writeln(files, ok); //Escreve False (valor da variável OK) na terceira linha.
  ...
  CloseFile(files); // CloseFile deve ser chamado após ter terminado de trabalha com o arquivo
  //  Ele encerra o arquivo e conclui a gravação.
end;
