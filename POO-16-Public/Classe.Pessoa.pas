...
type
  TPessoa = class
  private // É como uma Casa, só tem acesso quem morar nela
    FNome: String;
    FEtnia: String;
    FDataNasc: String;
    FSexo: String;
  ...
  protected // É como um grupo de Whatsapp da Familia, todos que estão tem acesso
    FWhatsapp : String;

  public // É com uma Postagem no Facebook, todos que utilizam a classe tem acesso
